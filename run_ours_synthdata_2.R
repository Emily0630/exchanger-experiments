...
expt_configs <- transpose(expand.grid(link_conf_mu = c(0.1, 1, 8, 100), dist_conf = 0:1, seed = 0, exp_num_recs = 10000))
...
future_map(expt_configs, function(e) {
  ...
  # Run for Coupon
  run_ours(expt_name, model, true_membership, n_samples = 50, burnin_interval = 500)
